...
@admin.action(description="Mark selected items as in for repairs")
...
@admin.action(description="Mark missing")
...
@admin.action(description="Return items from repair")
...
class RegulatorAdmin(admin.ModelAdmin):
    actions = [make_available, make_repair, return_from_repair, make_missing]
    list_display = ("number", "manufacturer", "serial_num", "next_service", "state")
