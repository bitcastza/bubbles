...
class EquipmentTableWidget(widgets.Widget):
    ...
    def __init__(self, *args, show_number=False, show_cost=False, item_cost=0, **kwargs):
...
class RequestEquipmentListField(fields.Field):
    ...
    def __init__(self, *args, show_number=False, show_cost=False,
                 item_cost=0, **kwargs):
        super().__init__(*args, **kwargs)
...
class RentalEquipmentListField(fields.Field):
    ...
    def clean(self, value):
        ...
        for v in value:
            try:
                item = Item.objects.get(number=v.item.number,
...
class EquipmentForm(forms.Form):
    ...
    def clean_period(self):
        ...
        if existing_periods.count() and self.request_id is None:
            raise forms.ValidationError(_('You already have a request/rental submitted '
